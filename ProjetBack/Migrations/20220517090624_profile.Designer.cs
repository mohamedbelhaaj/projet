...
namespace ProjetBack.Migrations
{
    ...
    [Migration("20220517090624_profile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.Imputation", b =>
                {
                    ...
                    b.Property<DateTime?>("DateAvalide")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<DateTime?>("FridayDate")
                        .HasColumnType("datetime2");

                    b.Property<int>("StatusImputation")
                        .HasColumnType("int");

                    b.Property<DateTime?>("ThursdayDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("TuesdayDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DAL.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("FirstImputation")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("LastImputation")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ProjetBack.Models.Profile", b =>
                {
            ...
            modelBuilder.Entity("ProjetBack.Models.ProjetEdp", b =>
                {
                    ...
                    b.Property<double>("BudgetInitial")
                        .HasColumnType("float");

                    b.Property<double?>("BudgetRallonge")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("budgetConfirme")
                        .HasColumnType("float");

                    b.Property<double?>("budgetConfirmeRallonge")
                        .HasColumnType("float");

                    b.Property<double?>("budgetDirection")
                        .HasColumnType("float");

                    b.Property<double?>("budgetDirectionRallonge")
                        .HasColumnType("float");

                    b.Property<double?>("budgetGP")
                        .HasColumnType("float");

                    b.Property<double?>("budgetGPRallonge")
                        .HasColumnType("float");

                    b.Property<double?>("budgetJunior")
                        .HasColumnType("float");

                    b.Property<double?>("budgetJuniorRallonge")
                        .HasColumnType("float");

                    b.Property<double?>("budgetSenior")
                        .HasColumnType("float");

                    b.Property<double?>("budgetSeniorRallonge")
                        .HasColumnType("float");

                    b.Property<double?>("budgetValidation")
                        .HasColumnType("float");

                    b.Property<double?>("budgetValidationRallonge")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("ProjetBack.Models.profileUser", b =>
                {
                    b.Property<string>("userId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DAL.Models.User", b =>
                {
                    b.HasOne("DAL.Models.Profil", null)
                        .WithMany("Users")
            ...
            modelBuilder.Entity("ProjetBack.Models.ProjetEdp", b =>
                {
                    ...
                    b.HasOne("ProjetBack.Models.Commercant", null)
                        .WithMany("ProjetEdp")
                        .HasForeignKey("Commercantid");

                    b.HasOne("DAL.Models.User", "Commercial")
                        .WithMany("ProjetsComercieaux")
            ...
            modelBuilder.Entity("ProjetBack.Models.profileUser", b =>
                {
                    b.HasOne("ProjetBack.Models.Profile", "Profile")
