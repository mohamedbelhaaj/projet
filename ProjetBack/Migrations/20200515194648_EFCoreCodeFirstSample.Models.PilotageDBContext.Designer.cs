...
namespace ProjetBack.Migrations
{
    ...
    [Migration("20200515194648_EFCoreCodeFirstSample.Models.PilotageDBContext")]
    partial class EFCoreCodeFirstSampleModelsPilotageDBContext
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DAL.Models.DetailImputation", b =>
                {
                    ...
                    b.Property<string>("IdImputation")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.Imputation", b =>
                {
                    ...
                    b.Property<string>("StatusImputationsIdStatusImputations")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("StatusImputationsIdStatusImputations");
            ...
            modelBuilder.Entity("DAL.Models.Projet", b =>
                {
                    ...
                    b.Property<string>("IdPhaseProjet")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DAL.Models.User", b =>
                {
                    ...
                    b.Property<string>("ProfilIdProfil")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ProjetBack.Models.Tache", b =>
                {
                    ...
                    b.Property<string>("ProjetIdProjet")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("StatutTacheIdStatutTache")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("StatutTacheIdStatutTache");
            ...
            modelBuilder.Entity("DAL.Models.Imputation", b =>
                {
                    b.HasOne("DAL.Models.StatusImputation", "StatusImputations")
                        .WithMany("Imputations")
                        .HasForeignKey("StatusImputationsIdStatusImputations");
            ...
            modelBuilder.Entity("DAL.Models.Projet", b =>
                {
                    b.HasOne("DAL.Models.DetailLivraison", "DetailLivraison")
                        .WithOne("Projet")
                        .HasForeignKey("DAL.Models.Projet", "Id");
            ...
            modelBuilder.Entity("ProjetBack.Models.Tache", b =>
                {
                    ...
                    b.HasOne("DAL.Models.StatutTache", "StatutTache")
                        .WithMany("Taches")
                        .HasForeignKey("StatutTacheIdStatutTache");
